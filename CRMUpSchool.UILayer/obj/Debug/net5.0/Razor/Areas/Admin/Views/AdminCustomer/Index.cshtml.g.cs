#pragma checksum "C:\Users\ozgen\source\repos\CRMUpSchool.UILayer\CRMUpSchool.UILayer\Areas\Admin\Views\AdminCustomer\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d10641dbfb0d44af1fab700adaa7bae029f00559"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d10641dbfb0d44af1fab700adaa7bae029f00559", @"/Areas/Admin/Views/AdminCustomer/Index.cshtml")]
...
<div class=""form-group"">
    ...
    <br />
    <input type=""text"" id=""txtCustomerSurname"" placeholder=""Müşteri soyadını giriniz."" cla");
...
<div class=""form-group"">
    ...
    <br />
    <input type=""text"" id=""txtSurname"" class=""form-control"" placeholder=""Güncellenecek so");
            WriteLiteral(@"yadınızı giriniz."" />
    <br />
        ...
        $.ajax({
            ...
            success: function (fonk1) {
                ...
                $.each(values, (index, item) => {
                    tableHtml += `<tr><td>${item.CustomerID}</td> <td>${item.CustomerName}</td> <td>${item.CustomerSurname}</td><td>${ite");
            WriteLiteral(@"m.CustomerMail}</td></tr>`
                });
    ...
    $(""#btnCustomerDelete"").click(x => {
        ...
        $.ajax({
            ...
            success: function (fonk4) {
                ...
                alert(""Müşt");
            WriteLiteral(@"eri başarıyla silindi."");
            }
        });
    })
